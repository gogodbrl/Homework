...
public class MyCounts extends Configured implements Tool {
	...
	static class WordCountsForDocsMapper extends
		...
		protected void map(LongWritable key, Text value, Context context)
			...
			String[] input = value.toString().split("\\s+"); //no blank
			String term = input[0];
	...
	static class WordCountsForDocsReducer extends Reducer<Text, Text, Text, Text> {
		/*
